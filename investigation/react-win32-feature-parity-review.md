...
| Keyboard shortcuts | Native accelerators and centralized `InputRouter` | No daemon work | **Partial**: registry-driven Ctrl+P/Ctrl+N/Ctrl+S/Ctrl+E/Ctrl+M/Enter/Escape with editable-field suppression; many workspace/view shortcuts remain | Extend the registry and generate a shortcuts reference/native accelerators | P0 | M | Conflicts suppressed in text fields; shortcuts discoverable and testable |
